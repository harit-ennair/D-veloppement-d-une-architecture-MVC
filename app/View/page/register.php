<?php include_once __DIR__.'/../layout/header.php'?>
    ...
    <form action="/MVC/register" method="POST" class="bg-white p-6 rounded-lg shadow-lg w-96 m-auto">
        <h2 class="text-2xl font-bold mb-4 text-center">Inscription</h2>
        
        <label class="block mb-2 text-gray-700">Nom d'utilisateur</label>
        ...
        <button type="submit" class="mt-6 w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600">S'inscrire</button>
    </form>
